...
async function harvest() {
  ...
  console.log('   1. Introduce tu correo y contraseña en la ventana emergente.');
  console.log('   2. Si Google te bloquea de nuevo, NO CIERRES. Intenta usar "Probar otra manera" si aparece.');
  console.log('   3. Una vez que veas la interfaz de Google Colab (tus notebooks), vuelve aquí.');
